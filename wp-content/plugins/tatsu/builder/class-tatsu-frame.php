...
class Tatsu_Frame {
	...
	public function frame_footer() {
		echo '<div id = "tatsu-observer"><div id = "tatsu-observer-tooltip"></div></div></div><div class="tatsu-drag-observer"></div><div class="tatsu-focus-edit"></div><div id="tatsu-tinymce-helper"></div><input type = "text" id = "tatsu-copy-paste-helper"/><div id = "tatsu-add-tools-helper"><div id = "tatsu-add-tools-icon-wrapper"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve"><g><polygon points="95.6,57.7 95.6,44.3 56.8,44.2 56.7,5.4 43.3,5.4 43.2,44.2 4.4,44.3 4.4,57.7 43.2,57.8 43.3,96.6 56.7,96.6    56.8,57.8  "></polygon></g></svg></div></div><div id = "tatsu-modulelist-drawer-overlay"><div id = "tatsu-modulelist-drawer-overlay-inner-text"><span id = "tatsu-modulelist-drawer-maintext">Click on a module to add it</span><span id = "tatsu-modulelist-drawer-subtext">or click anywhere here to close</span></div></div>';
	}	
