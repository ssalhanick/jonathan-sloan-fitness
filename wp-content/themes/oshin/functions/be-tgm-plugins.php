...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'BE To Tatsu Converter', // The plugin name
			'slug'     				=> 'be-to-tatsu', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory_uri() . '/lib/plugins/be-to-tatsu.zip', // The plugin source
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/lib/plugins/be-themes-one-click-import.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
